...
export function TypingText({ onEasterEgg }: TypingTextProps) {
  ...
  return (
    <div className="text-center z-10 relative px-4">
      ...
      <h1 className="text-8xl md:text-9xl font-bold font-mono tracking-tight drop-shadow-[0_0_40px_rgba(225,120,40,0.35)] dark:drop-shadow-[0_0_40px_rgba(68,255,136,0.5)]">
      ...
      <div className="mt-8 max-w-2xl mx-auto">
        <div className="backdrop-blur-md bg-background/40 dark:bg-background/60 rounded-2xl px-6 py-4 border border-primary/30 shadow-[0_0_30px_rgba(225,120,40,0.12)] dark:shadow-[0_0_30px_rgba(68,255,136,0.15)]">
...
CS student & full-stack developer — databases, REST APIs, and ML/AI, shipped to production.
          </p>
        </div>
      </div>
    </div>
