...
const socialLinks = [
  ...
  { icon: Linkedin, label: "LinkedIn", href: "https://linkedin.com/in/geuelrivera" },
  { icon: Mail, label: "Email", href: "mailto:gjrvlio.dev@gmail.com" },
  { icon: Phone, label: "Call", href: "tel:+639947155779" },
]
      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
            CS student seeking a software engineering internship. Open to new projects, collaboration, or
            opportunities. Based in Valenzuela City, Metro Manila.
          </p>
        </div>
        ...
        <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
          <CardContent className="p-8">
            ...
            <div className="mt-8 p-6 rounded-lg bg-muted/50 text-center">
              ...
              <a href="mailto:gjrvlio.dev@gmail.com" className="text-lg font-mono text-primary hover:underline">
                gjrvlio.dev@gmail.com
              </a>
            </div>
          </CardContent>
        </Card>
        ...
        <footer className="mt-16 text-center text-sm text-muted-foreground">
          <p>© 2026 Geuel John Rivera. Built with Next.js, Three.js, and passion.</p>
        </footer>
      </div>
    </section>
  )
